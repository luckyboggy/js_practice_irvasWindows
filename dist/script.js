...
/* harmony import */ var _modules_images__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/images */ "./src/js/modules/images.js");
 ...
 // Скрипты начитают работать только когда DOM-структура готова

window.addEventListener('DOMContentLoaded', function () {
  "use strict";

  var modalState = {};
  var deadline = '2022-09-15';
...
var changeModalState = function changeModalState(state) {
  ...
  function bindActionToElems(event, elem, prop) {
    elem.forEach(function (item, i) {
      item.addEventListener(event, function () {
        ...
        //     // Создаётся поле prop в объекте state
        //     state[prop] = i;
        // } else {
        //     state[prop] = item.value;
        //}
  ...
  bindActionToElems('change', windowProfile, 'profile'); // windowForm.forEach((item, i) => {
  //     item.addEventListener('click', () => {
  //         // Создаётся поле form в объекте state
  //         state.form = i;
  //         console.log(state);
  //     })
  // });
...
var forms = function forms(state) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            document.querySelector('.status').textContent = message.loading; // fetch возвращает промис (который нужно ещё раз обработать)
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (event) {
      ...
      event.preventDefault(); // Создание элемента для вывода сообщений

      var statusMessage = document.createElement('div');
      statusMessage.classList.add('status'); // Помещаем созданный div в конец выбранной формы
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (event) {
        ...
        mWindows.forEach(function (item) {
          item.style.display = 'none';
        }); // Делает элемент modal видимым

        modal.style.display = 'block'; // Отмена прокрутки остальной страницы

        document.body.style.overflow = 'hidden';
        document.body.style.marginRight = "".concat(scroll, "px"); // Через классы bootstrap
    ...
    close.addEventListener('click', function () {
      ...
      modal.style.display = 'none'; // разрещение прокрутки страницы

      document.body.style.overflow = '';
      document.body.style.marginRight = "0"; // Через классы bootstrap
